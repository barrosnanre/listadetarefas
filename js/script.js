let addBtn = document.getElementById("criar");
let task = document.getElementById("tarefas");
let list = document.getElementById("listadetarefas");
let delBtn = document.getElementById("bin");
let delAll = document.getElementById("apagar");
let id = 0;
...
function addItem(taskValue){
    if(taskValue.length===0){
        ...
        img.setAttribute("src", "./imagens/deletebutton.svg");
